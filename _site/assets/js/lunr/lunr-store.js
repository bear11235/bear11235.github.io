var store = [{
        ...
        "excerpt":"ML vs DL 딥러닝을 주목받게 만든 3가지 요인 Neural Network: 데이터 처리 기법 Big data: 패턴을 찾을 만한 충분한 데이터에 접근 가능하다. GPU: 수많은 연산을 처리할 수 있는 하드웨어 발전. 기존 머신러닝과의 비교 데이터가 적을 시 상대적으로 좋은 성능을 보인다. 하지만 데이터가 많을 때에는, 많은 데이터를 반영할 만큼 모델의 복잡도가...","categories": ["study","ML-DL"],
        "tags": ["study","ML-DL"],
        "url": "/study/ml-dl/DL-introduction/",
        "teaser": null
      },{
        "title": "[ML/DL] DL - Optimization",
        "excerpt":"Expected Risk Minimization (ERM) 여기서 risk란 loss 혹은 error의 의미로 생각하면 될듯. 즉 expected risk는 데이터 분포에서 기대되는 risk이다. 하지만 우리는 거의 모든 상황에서 데이터의 분포 \\(dP_{\\tau}(x,y)\\)를 알지 못한다. 따라서 Monte Carlo 방식으로 기대값을 구한다. ERM의 방식은 overfitting 문제에 빠지기 쉽다. 따라서 generalization을 보완할 수 있는 추가적인 항이 필요하다. \\[R(f_{\\theta},...","categories": ["study","ML-DL"],
        "tags": ["study","ML-DL"],
        "url": "/study/ml-dl/DL-optimization/",
        "teaser": null
      },{
    ...
    "excerpt":"[ML/DL] DL - Optimization June 12, 2023 최대 1 분 소요 Expected Risk Minimization (ERM) 여기서 risk란 loss 혹은 error의 의미로 생각하면 될듯. 즉 expected risk는 데이터 분포에서 기대되는 risk이다. 하지만 우리는 거의 모든 상황에서 데이터의 분포 \\(dP_{\\tau}(x,y)\\)를 ... [ML/DL] DL introduction June 12, 2023 최대 1 분 소요 ML...","url": "http://localhost:4000/study/ML-DL"
  },{
    "title": "Turbomachines",
    "excerpt":"                              test                                                                     April 16, 2023                                                                           최대 1 분 소요                                        ","url": "http://localhost:4000/study/turbo-machines"
  },{
    "title": "Turbulence",
    "excerpt":"Coherent Structures in Turbulence May 13, 2023 1 분 소요 Coherent structures and turbulence (1968) Journal of Fluid Mechanics (1986) Author: FAZLE HUSSAIN Turbulence Equations May 12, 2023 최대 1 분 소요 Types of Turbulence Statistically Homogeneous Turbulence All statistics of fluctuating quantities are invariant under translation of the coordinate...","url": "http://localhost:4000/study/turbulence"
  },{
    "title": "study",
    "excerpt":"[ML/DL] DL - Optimization June 12, 2023 최대 1 분 소요 Expected Risk Minimization (ERM) 여기서 risk란 loss 혹은 error의 의미로 생각하면 될듯. 즉 expected risk는 데이터 분포에서 기대되는 risk이다. 하지만 우리는 거의 모든 상황에서 데이터의 분포 \\(dP_{\\tau}(x,y)\\)를 ... [ML/DL] DL introduction June 12, 2023 최대 1 분 소요 ML...","url": "http://localhost:4000/study"
  },{
